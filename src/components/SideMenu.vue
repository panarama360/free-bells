<template>
  <div class="navigation-buttons">
    <MenuButton to="/dashboard">
      <svg style="display: block; margin: auto; height: 100%" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<!--    <MenuButton to="/dashboard/tables"  type="submit">-->
<!--      <span style="font-size: 2rem; color: #969CBA; text-decoration: none!important;" class="fas fa-table"></span>-->
<!--    </MenuButton>-->
    <MenuButton to="/dashboard/buttons"  type="submit" v-if="currentOrganisation?.owner">
      <span style="font-size: 2rem; color: #969CBA; text-decoration: none!important;" class="fas fa-arrows-alt"></span>
    </MenuButton>
    <MenuButton to="/dashboard/settings" v-if="currentOrganisation?.owner">
        <svg style="display: block; margin: auto; height: 100%" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <MenuButton to="/dashboard/users" v-if="currentOrganisation?.owner">
      <svg style="display: block; margin: auto; height: 100%" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M3 21C3 17.625 7.5 17.625 9.75 15.375C10.875 14.25 7.5 14.25 7.5 8.625C7.5 4.87538 8.99962 3 12 3C15.0004 3 16.5 4.87538 16.5 8.625C16.5 14.25 13.125 14.25 14.25 15.375C16.5 17.625 21 17.625 21 21" stroke="#969CBA" stroke-width="2" stroke-linecap="square"/>
      </svg>
    </MenuButton>
  </div>
</template>
