  ...
  <div class="sign-up">
    <div class="sign-up-form">
      <div class="left-form">
        ...
        <Button class="m-1" @click="login" text="LOG IN"/>
      </div>
      <div class="right-form">
        <h1 class="page-title">Free Bell</h1>
        <h1 class="page-title">Login Page</h1>
        <router-link to="/registration" class="registration">Зарегистрироваться</router-link>
      </div>
    </div>
  </div>
</template>
  ...
  methods: {
    async login(){
      try {
        ...
        await appFirebase.auth().signInWithEmailAndPassword(this.email, this.password);
